...
<head>
    ...
    <title>View Student - Library Management System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="detail-container">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">${student.marks}</div>
            </div>
            
            <c:if test="${not empty student.borrowedBooks}">
                <div class="book-section">
                    <h3>Borrowed Books</h3>
                    <ul class="book-list">
                        <c:forEach var="book" items="${student.borrowedBooks}">
                            <li class="book-item">
            ...
            <c:if test="${empty student.borrowedBooks}">
                <div class="book-section">
                    <h3>Borrowed Books</h3>
                    <p style="color: #666;">No books borrowed yet.</p>
                </div>
            </c:if>
            
            <div class="actions">
                <a href="${pageContext.request.contextPath}/students/edit/${student.id}" class="btn btn-warning">Edit Student</a>
